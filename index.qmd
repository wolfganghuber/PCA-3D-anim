...
For more on the athletes' data, see [the MSBM book](https://www.huber.embl.de/msmb/07-chap.html#what-are-the-data-matrices-and-their-motivation).
...
theta2 = atan2(normalvec[2], normalvec[1]) + pi/2 # I'm not quite sure about, looks hacky
```
